    ...
    return (
        <>
            ...
            <div className="min-h-screen pb-10 space-y-6">
                ...
                <h1 className="text-xl font-bold text-[#1A1A1A] dark:text-white  uppercase">Settings</h1>
                        ...
                        <nav className="space-y-1">
                            {[
                                ...
                                <button
                                    ...
                                    className={`w-full text-left px-8 py-4 text-[10px] font-semibold uppercase  transition-all relative flex items-center gap-3 ${activeTab === tab.id
                    ...
                    <div className="flex-1 p-8 md:p-12">
                        {activeTab === "profile" && (
                            <div className="space-y-12 animate-in fade-in slide-in-from-right-4 duration-500">
                                <div className="flex items-center justify-between">
                                    <h2 className="text-sm font-bold text-gray-900 dark:text-white uppercase ">My Profile</h2>
                                </div>
                                ...
                                <div className="bg-white dark:bg-[#1C1C1C] border border-gray-100 dark:border-white/5 p-8 rounded-none flex flex-col sm:flex-row items-center justify-between gap-8">
                                    <div className="flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left">
                                        <div className="relative group">
                                            <div className="w-24 h-24 rounded-none overflow-hidden bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 flex items-center justify-center">
                                                {user?.firstName ? (
                                                    <img
                                                        src={`https://ui-avatars.com/api/?name=${user.firstName}&background=465fff&color=fff&size=200`}
                                                        alt={user.firstName}
                                        ...
                                        <div>
                                            <h3 className="text-sm font-bold text-gray-900 dark:text-white uppercase ">{user?.firstName || "User Name"}</h3>
                                    ...
                                    <button className="px-6 py-3 text-[10px] font-bold bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-700 dark:text-white uppercase  hover:border-brand-500 hover:text-brand-500 transition-all flex items-center gap-2 rounded-none">
                                ...
                                <div className="space-y-8 bg-white dark:bg-[#1C1C1C] border border-gray-100 dark:border-white/5 p-8 rounded-none">
                                    <div className="border-b border-gray-100 dark:border-white/5 pb-4">
                                        <h3 className="text-[10px] font-bold text-gray-900 dark:text-white uppercase ">Personal Information</h3>
                                    </div>

                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-bold text-gray-400 uppercase ">Full Name</label>
                                            <p className="text-xs font-bold text-gray-900 dark:text-white uppercase ">{user?.firstName + " " + user?.lastName || "—"}</p>
                                        </div>
                                        <div className="space-y-2">
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-bold text-gray-400 uppercase ">Organisation ID</label>
                                            <div className="flex items-center gap-2">
                                                <Globe className="w-3.5 h-3.5 text-brand-500" />
                                                <p className="text-xs font-bold text-gray-900 dark:text-white uppercase ">{currentOrganization?.id || "—"}</p>
                                            </div>
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-bold text-gray-400 uppercase ">Organisation Name</label>
                                            <div className="flex items-center gap-2">
                                                <Home className="w-3.5 h-3.5 text-brand-500" />
                                                <p className="text-xs font-bold text-gray-900 dark:text-white uppercase ">{currentOrganization?.name || "Direct Organisation"}</p>
                                            </div>
                                        </div>
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <p className="text-xs font-bold text-gray-900 dark:text-white uppercase ">{currentOrganization?.role || "Member"}</p>
                                            </div>
                                        </div>
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-bold text-gray-400 uppercase ">Account Created</label>
                                            <div className="flex items-center gap-2">
                        ...
                        {activeTab === "password" && (
                            <div className="space-y-10 animate-in fade-in slide-in-from-right-4 duration-500 max-w-lg">
                                <div>
                                    <h2 className="text-sm font-bold text-gray-900 dark:text-white uppercase ">Change Password</h2>
                                    <p className="text-[10px] text-gray-400 font-bold uppercase  mt-1">Update your account password regularly to stay secure.</p>
                                </div>
                        ...
                        {activeTab === "security" && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h2 className="text-sm font-bold text-gray-900 dark:text-white uppercase ">Security Logs</h2>
                                        <p className="text-[10px] text-gray-400 font-bold uppercase  mt-1">Review your recent account activity.</p>
                                    </div>
                                    <button className="px-4 py-2 bg-brand-500/10 text-brand-500 text-[10px] font-bold uppercase  border border-brand-500/20 rounded hover:bg-brand-500 hover:text-white transition-all">
                                        Export All
                                    </button>
                                </div>
                                        ...
                                        <table className="w-full text-left">
                                            <thead>
                                                <tr className="bg-gray-50 dark:bg-white/[0.03] border-b border-gray-100 dark:border-white/5">
                                                    <th className="px-6 py-4 text-[9px] font-bold text-gray-400 uppercase ">#</th>
                                                    <th className="px-6 py-4 text-[9px] font-bold text-gray-400 uppercase ">Time</th>
                                                    <th className="px-6 py-4 text-[9px] font-bold text-gray-400 uppercase ">Details</th>
                                                </tr>
                                            </thead>
                                                    ...
                                                    <tr key={log.id} className="hover:bg-gray-50 dark:hover:bg-white/[0.01] transition-colors">
                                                        ...
                                                        <td className="px-6 py-4">
                                                            <div className="space-y-1">
                                                                <p className="text-[10px] font-bold text-gray-900 dark:text-white uppercase ">{log.details}</p>
                        ...
                        {["password", "security"].includes(activeTab) && (
                            <div className="flex flex-col items-center justify-center min-h-[400px] text-center space-y-4">
                                ...
                                <h3 className="text-sm font-bold text-gray-900 dark:text-white uppercase ">{activeTab.replace('-', ' ')}</h3>
                                <p className="text-[10px] text-gray-400 font-bold uppercase ">This section is coming soon</p>
                            </div>
                        )}
                    </div>
                </div>
